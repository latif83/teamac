        ...
        <>
            {openSidebar && <div className="bg-[#1e629a] w-[230px] shrink-0 sticky top-0 h-svh transition duration-1000">
                ...
                <div className="flex flex-col gap-3 pl-5 py-5 mt-5 text-sm">
                    ...
                    <Link onClick={()=>{mobileScreen && setOpenSidebar(false)}} className={`w-full ${pathname == "/admin/applicants" ? "bg-[#f2f2f2] text-gray-800" : "text-gray-50"} rounded-l sm:p-2 p-2 py-4 flex gap-1.5 items-center hover:font-bold`} href={'/admin/applicants'}>
                    ...
                    <Link onClick={()=>{mobileScreen && setOpenSidebar(false)}} className={`w-full ${pathname == "/admin/users" ? "bg-[#f2f2f2] text-gray-800" : "text-gray-50"} rounded-l sm:p-2 p-2 py-4 flex gap-1.5 items-center hover:font-bold`} href={'/admin'}>
