    ...
    <section className="py-16 md:px-12 px-4 bg-gradient-bto- from-[#00B4D8] bg-[#FF6F61]">
      ...
      <div className="mt-0 text-center">
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          >
            <div className="w-24 h-24 rounded-full border mb-4 p-3"><Image src={'/man_avatar.png'} width={500} height={500} className="w-full h-full" alt="Avatar Image" /></div>
            ...
            >
              ...
              <span>info@teamacgloballtd.com</span>
            </Link>
          ...
          >
            ...
            <Link
              href="tel:+2348061321458" // Use the 'tel:' protocol for clicking to call
              className="text-sm text-gray-600 flex items-center gap-2 hover:text-blue-600 transition" // Added hover effect for UX
              title="Call now"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
