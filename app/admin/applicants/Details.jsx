            ...
            <div className="bg-white rounded-t-lg overflow-y-auto shadow-lg w-full h-full max-w-3xl relative md:p-6 p-3">
                ...
                <div className="mt-8 grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-700">{applicant.fullName}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className={`text-sm ${applicant.status == "Pending" ? 'text-orange-700' : 'text-green-700'}`}>{applicant.status}</p>
                    </div>

                    <div className="md:col-span-2">
                        <p className="font-bold text-red-600 text-xs">Additional Info</p>
                        <p className="text-sm text-gray-700">{applicant.additionalInfo || "N/A"}</p>
                    </div>

                </div>

                <div className="mt-4 grid md:grid-cols-2 gap-4">
<button type="button" className="text-sm flex items-center gap-2 bg-green-600 hover:opacity-80 cursor-pointer text-white py-2 px-4 rounded-lg justify-center">
