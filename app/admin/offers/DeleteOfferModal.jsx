...
export const DeleteOffer = ({ setDeleteOffer, offerId, setFetchData, setViewOffer }) => {
    ...
    const deleteOffer = async () => {
        try {
            ...
            toast.success(data.msg || 'Offer deleted successfully!')
            setFetchData(true)
            setViewOffer(false)
            ...
            console.log(e)
            toast.error('An unexpected error occurred while deleting the offer!')
        } finally {
            setLoading(false)
        }
    }
