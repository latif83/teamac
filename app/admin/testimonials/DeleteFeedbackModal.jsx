...
export const DeleteFeedback = ({ setDeleteFeedback, feedbackId, setFetchData, setViewFeedback }) => {
    ...
    const deleteFeedback = async () => {
        try {
            ...
            if (!res.ok) {
                toast.error(data.msg || 'Failed to delete feedback!')
                return
            }

            toast.success(data.msg || 'Feedback deleted successfully!')
            setFetchData(true)
