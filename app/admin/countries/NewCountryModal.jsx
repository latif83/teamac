...
export const NewCountryModal = ({ setAddCountry, setFetchCountries }) => {
    ...
    return (
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center px-4 md:pt-12 md:pt-6">
            <div className="bg-white rounded-t-lg shadow-lg w-full h-full max-w-2xl relative md:p-6 p-3">
